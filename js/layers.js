addLayer("p", {
    ...
    layerShown(){return true},    upgrades: {
        ...
        15: {
            title: "Money boosts itself up to 10000 points",
...
addLayer("r", {
    ...
    layerShown(){return true},    upgrades: {
        17: {
            title: "Increase Money Gain by 3x",
            description: "Increase your money",
            cost: new Decimal(2),
        },
        18: {
            title: "Increase Money Gain by a random integer",
            description: "between 2 and 6 obviously",
            cost: new Decimal(8),
        },
        19: {
            title: "Increase Money Gain by 2x",
            description: "Increase your money again",
            cost: new Decimal(35),
        },
    },
})
